$(document).ready(function() {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Menard and Lara's Wedding",

            // Event start date
            start: new Date('June 8, 2024 12:15'),
    ...
    $('#rsvp-form').on('submit', function(e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbycp6JshH_SCPKOpVd_KpCJe16Y1dNFAOjLx0IkTcTFZBA4DP5qirxSuFjSGbKmgx9z/exec', data)
                .done(function(data) {
                    console.log(data);
